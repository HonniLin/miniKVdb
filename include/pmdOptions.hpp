...
#define CONFFILENAME "edb.conf" //数据库的配置文件
#define LOGFILENAME  "diag.log" //日志的打印
#define DBFILENAME   "edb.data"
#define SVCNAME      "48127" //默认的服务端口
#define NUMPOOL      20      //线程池的大小
